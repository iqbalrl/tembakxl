...
zydekenzou=(gt+"""
     d88888D db    db d8888b. d88888b db   dD d88888b d8b   db d88888D  .d88b.  db    db 
     YP  d8' `8b  d8' 88  `8D 88'     88 ,8P' 88'     888o  88 YP  d8' .8P  Y8. 88    88 
        d8'   `8bd8'  88   88 88ooooo 88,8P   88ooooo 88V8o 88    d8'  88    88 88    88 
       d8'      88    88   88 88~~~~~ 88`8b   88~~~~~ 88 V8o88   d8'   88    88 88    88 
      d8' db    88    88  .8D 88.     88 `88. 88.     88  V888  d8' db `8b  d8' 88b  d88 
     d88888P    YP    Y8888D' Y88888P YP   YD Y88888P VP   V8P d88888P  `Y88P'  ~Y8888P' 
""")
l="Harap tunggu.."
